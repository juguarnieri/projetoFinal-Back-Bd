...
('Ela cuida das mentes mais pertubadas - Gabriela Cruz', 'Ela conhece a mente dos pedofilos! Gabriela Cruz e uma renomada psicologa especialista em sexualidade humana. Antes de atender em clinicas, ela trabalhou durante anos em penitenciarias, acompanhando individuos condenados por pedofilia e outros crimes sexuais', 'https://youtu.be/mdwQUT0i5dc?feature=shared', 'https://i.ytimg.com/vi/mdwQUT0i5dc/maxresdefault.jpg', 'crimes antigos', TRUE),
...
('O crime contra Clara Maria', 'Clara Maria, de 21 anos, desaparecida em Belo Horizonte desde 9 de marco, foi encontrada morta e concretada no jardim de uma residencia no bairro Ouro Preto. Dois homens, de 27 e 29 anos, foram presos em flagrante.', 'https://www.youtube.com/watch?v=aNRHlRWn8Pg', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnNkPTmSnzWwvCav10RrHel5hn5wIm4cg6uw&s', 'casos reais', TRUE);
...
('Crimes Reais: Ricardo Salada e Jorge Lordello', 'Analise de casos criminais com especialistas.', 'https://www.youtube.com/watch?v=aPEYYaR8hVY', 'https://i.ytimg.com/vi/aPEYYaR8hVY/maxresdefault.jpg', 'casos reais', FALSE),
...
('Bernado Boldrini', 'O caso Bernardo Boldrini refere-se ao assassinato de um menino de 11 anos, Bernardo Uglione Boldrini, em 2014, em Tres Passos, no Rio Grande do Sul. O crime, que chocou o Brasil, envolveu o pai, Leandro Boldrini, a madrasta, Graciele Ugulini, e dois amigos do casal, Edelvania e Evandro Wirganovicz, todos condenados por homicidio e ocultação de cadaver.' , 'https://www.youtube.com/watch?v=S4d2K0uEjNo', 'https://i.ytimg.com/vi/S4d2K0uEjNo/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDrXmGtEJtLinKhgLxMd6X_uKMfAQ', 'impactante', TRUE),
